...
namespace LabNation.DeviceInterface.Devices
{
    partial class SmartScope
    {
        ...
        public void SetAwgData(double[] data)
        {
            ...
            hardwareInterface.SetControllerRegister(Hardware.ScopeController.AWG, 0, convertedBytes);
        }
        ...
        public void SetAwgStretching(int stretching)
        {
            ...
            FpgaSettingsMemory[REG.AWG_DECIMATION].Set((byte)stretching);
        }
